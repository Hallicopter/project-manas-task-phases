...
def find_lane():
    resource = '/home/advait/catkin_ws/src/beginner_tutorials/scripts/lane_detection.py/lanevid_hard.mov'
    ...
    for i in range(5000):
        ...
        cv2.line(frame,((x1_l/n_l),(y1_l/n_l)),(x2_l/n_l,y2_l/n_l),(0,255,0),30)
